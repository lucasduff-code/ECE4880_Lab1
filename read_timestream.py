...
read_client = session.client('timestream-query', region_name='us-east-2', aws_access_key_id='', aws_secret_access_key='', config=Config(read_timeout=20, max_pool_connections = 5000, retries={'max_attempts': 10}))
